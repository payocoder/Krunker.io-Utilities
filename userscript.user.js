...
// @resource        baiduCommonStyle     http://ibaidu.ntaow.com/newcss/baiduCommonStyle.css?t=23.23
// @resource        baiduOnePageStyle    http://ibaidu.ntaow.com/newcss/baiduOnePageStyle.css?t=23.23
// @resource        baiduTwoPageStyle    http://ibaidu.ntaow.com/newcss/baiduTwoPageStyle.css?t=23.23
// @resource        baiduLiteStyle       http://ibaidu.ntaow.com/newcss/baiduLiteStyle.css?t=23.23
// @resource        googleCommonStyle    http://ibaidu.ntaow.com/newcss/googleCommonStyle.css?t=23.23.1
// @resource        googleOnePageStyle   http://ibaidu.ntaow.com/newcss/googleOnePageStyle.css?t=23.23
// @resource        googleTwoPageStyle   http://ibaidu.ntaow.com/newcss/googleTwoPageStyle.css?t=23.23.1
// @resource        bingCommonStyle      http://ibaidu.ntaow.com/newcss/bingCommonStyle.css?t=23.23
// @resource        bingOnePageStyle     http://ibaidu.ntaow.com/newcss/bingOnePageStyle.css?t=23.23
// @resource        bingTwoPageStyle     http://ibaidu.ntaow.com/newcss/bingTwoPageStyle.css?t=23.23
// @resource        sogouCommonStyle     http://ibaidu.ntaow.com/newcss/sogouCommonStyle.css?t=23.23
// @resource        sogouOnePageStyle    http://ibaidu.ntaow.com/newcss/sogouOnePageStyle.css?t=23.23
// @resource        sogouTwoPageStyle    http://ibaidu.ntaow.com/newcss/sogouTwoPageStyle.css?t=23.23
// @resource        MainHuYanStyle       http://ibaidu.ntaow.com/newcss/HuYanStyle.css?t=23.23
// @grant           GM_getValue
// @grant           GM.getValue
// @grant           GM_setValue
// @grant           GM.setValue
                ...
                let DealRedirect = function (request, curNodeHref, respText, RegText) {
                    ...
                    if (resultResponseUrl != null && resultResponseUrl != "" && resultResponseUrl.indexOf("www.baidu.com/link") < 0) {
                        try {
                            ...
                            let host = getBaiduHost(resultResponseUrl);
                ...
                function addFavicon(citeList) {
                    for (let index = 0; index < citeList.length; index++) {
                        if (null == citeList[index].getAttribute("ac_faviconStatus")) {
                            let url = getBaiduHost(citeList[index]);
            ...
            function FSBaidu() { // thanks for code from 浮生@未歇 @page https://greasyfork.org/zh-TW/scripts/31642
                ...
                let ControlManager = {
                    ...
                    centerDisplay: function () {
                        AC_addStyle("body[google] .baidu{margin-top:-1rem;left: -200px;}.minidiv #logo img{width: 100px;height: unset;margin-top: 0.3rem;}", "AC-style-logo", "head");
